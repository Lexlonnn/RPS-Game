...
export default function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>Rock Paper Scissors - The Ultimate Challenge</title>
        <meta name="description" content="Play the classic game of Rock Paper Scissors with a modern twist. Outsmart your opponent and claim victory!" />
      </Head>
